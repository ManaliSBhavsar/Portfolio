...
function About() {
  return (
    <section>
      <H2>About Me</H2>
      <P>
        Hi, I am Manali Bhavsar, a frontend developer at <b className="font-bold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent"><a href= 'https://www.tcs.com/' target='_blank'>TCS</a></b>. My journey into Computer Science started in high school when my first
      ...
      <br />
      <P>
        Flash forward to now — I've worked as a <b className="font-bold bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent">Frontend Developer</b> for
