...
function ProjCard(props: ProjCardsProps) {
  return (
      <div className="bg-white p-6 shadow-lg rounded-lg border border-gray-400 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl focus:scale-105 focus:shadow-2xl dark:bg-white/3">
        <P>{props.year}</P>
